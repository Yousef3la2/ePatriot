    ...
    <div className="hero-section">
      <div className="left-part">
        ...
        <p className="hero-desc">
          An interactive platform that teaches children how to stay safe online
          through fun lessons, activities, and quizzes, and also provides
          parents and teachers with tools to monitor and ensure their progress.
        </p>
