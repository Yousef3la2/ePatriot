        ...
        <button className="faq-question" onClick={onToggle}>
          ...
          <div className={`faq-question-arrow ${isActive ? "open" : ""}`}>
            ...
            >
              ...
              />
              <path
                d="M12 21.08C11.59 21.08 11.25 20.74 11.25 20.33L11.25 3.5C11.25 3.09 11.59 2.75 12 2.75C12.41 2.75 12.75 3.09 12.75 3.5L12.75 20.33C12.75 20.74 12.41 21.08 12 21.08Z"
                fill="white"
              />
            </svg>
          </div>
